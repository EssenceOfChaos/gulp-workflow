...
gulp.task('watch-sass', function() {
  gulp.watch('stylesheets/**/*.sass', ['compile-sass']);
});

gulp.task('watch-scss', function() {
  gulp.watch('stylesheets/**/*.scss', ['compile-scss']);
});

gulp.task('watch-coffee', function() {
  var watchBrowserify = watchify(browserifyInstance('./javascripts/application.coffee', _.assign(watchify.args, { debug: true })));
...
gulp.task('compile-coffee', function() {
  var stream = browserifyInstance('./javascripts/application.coffee',
